      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="font-bold text-slate-100 tracking-tight text-lg">
            SEALED <span className="text-xs font-mono font-normal text-emerald-400 border border-emerald-500/30 px-1.5 py-0.5 rounded ml-1">Protocol Spec</span>
          </span>
        </div>
        ...
        <div className="flex items-center gap-4">
          <a href="/demo" className="px-4 py-2 text-xs font-medium bg-slate-100 text-slate-950 rounded-md hover:bg-white transition-all">Launch Demo</a>
        </div>
      </div>
    </header>
  );
